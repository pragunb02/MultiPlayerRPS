...
//   // const originalGame = new Chess(); // Store a copy of the original game instance
...
//     console.log(game.fen());
//     // consoel.log(game.fen);
//     // updateStatus(); // Update the status display
//   }
//   // // Function to update the board to the current move
//   // function updateBoardToMove(index) {
//   //   const tempGame = new Chess(originalGameFEN); // Use the original game state
//   //   const moves = Object.values(moveObj).slice(0, index);
...
let currentMoveIndex = 0; // Track the current move index
const originalGame = new Chess();
const navigationGame = new Chess(); // Create a separate instance for navigation
